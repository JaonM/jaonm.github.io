...
最近不断有学者研究让机器自动写作的课题，如Samuel Bowman等发表的"Generating Sentences from a Continuous Space"的文章，如下图所示

![](https://ws3.sinaimg.cn/large/006tNbRwgy1fuyi3uqoo5j313y0qqtyb.jpg)

<center>文本生成举例</center>

文章主要通过VAE (Variational Auto Encoder)学习到一个连续的句子表示空间，从而可以生成得到一连串相对连续的句子。
